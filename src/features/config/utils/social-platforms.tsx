...
function SteamIcon({
  ...
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M11.979 0C5.678 0 .511 4.86.022 11.037l6.432 2.658c.545-.371 1.203-.59 1.912-.59.063 0 .125.004.188.006l2.861-4.142V8.91c0-2.495 2.028-4.524 4.524-4.524 2.494 0 4.524 2.031 4.524 4.527s-2.03 4.525-4.524 4.525h-.105l-4.076 2.911c0 .052.004.105.004.159 0 1.875-1.515 3.396-3.39 3.396-1.635 0-3.016-1.173-3.331-2.727L.436 15.27C1.862 20.307 6.486 24 11.979 24c6.627 0 12-5.373 12-12s-5.375-12-12-12zm-.026 8.178l-.003.001-.005-.001zm-.768.897a2.044 2.044 0 0 0-2.044 2.044 2.044 2.044 0 0 0 4.088 0 2.044 2.044 0 0 0-2.044-2.044zm5.16 0a2.044 2.044 0 0 0-2.044 2.044 2.044 2.044 0 0 0 4.088 0 2.044 2.044 0 0 0-2.044-2.044z" />
    </svg>
  );
}
